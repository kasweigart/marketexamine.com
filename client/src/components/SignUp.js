            ...
            <ModalBody>
              <Form onSubmit={onSubmit}>
                <FormGroup>
                  ...
                  <Input type="text" name="name" id="name" placeholder="" value={name} onChange={onChangeName}/>
                </FormGroup>
                <FormGroup>
                  <Label for="email">Email</Label>
                  <Input type="email" name="email" id="email" placeholder="" value={email} onChange={onChangeEmail}/>
                </FormGroup>
                 <FormGroup>
                  ...
                  <ModalFooter>
                  <Button typecolor="secondary" type='submit'>Sign Up</Button>
